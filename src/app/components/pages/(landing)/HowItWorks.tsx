        ...
        >
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              ...
              <div className="absolute inset-0 border-2 border-blue-500 rounded-[80px] opacity-0 animate-border-highlight" />
            </motion.div>
          </div>
...
function Connector() {
  return (
    <div className="relative w-14 h-px overflow-hidden">
      ...
      <div className="absolute inset-0 border-t-2 border-blue-500 opacity-0 animate-dash-highlight" />
    </div>
  );
}
